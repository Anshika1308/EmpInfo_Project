...
const Pagination = ({pages, setCurrentPage, currentCustomer, sortedCustomer}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentCustomer.length}</b> out of <b>{sortedCustomer.length}</b> entries</div>
